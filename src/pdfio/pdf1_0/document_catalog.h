...
public:
    ...
    * Initializes base dictionary with required entries.
    */
   DocumentCatalog();
   ...
   /*! \brief Checks whether internal dictionary contains entry with key
    *  "Outlines".
    */
   ...
   /*! \brief Returns value by key "PageMode".*/
   Name &pageMode();
   /*! \brief Initializes internal dictionary with required and optional 
    * entries.
    */
   void prepare4Read();
