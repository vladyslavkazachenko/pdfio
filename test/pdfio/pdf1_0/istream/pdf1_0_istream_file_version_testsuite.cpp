...
%%EOF\n");
	...
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].objectNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries().size() == 7);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[0].byteOffset() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[0].generationNumber() == 65535);
	EXPECT_FALSE(fileVersion.xref().section().subsections()[0].entries()[0].isInUse());
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[1].byteOffset() == 9);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[1].generationNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[1].isInUse());
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[2].byteOffset() == 74);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[2].generationNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[2].isInUse());
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[3].byteOffset() == 120);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[3].generationNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[3].isInUse());
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[4].byteOffset() == 179);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[4].generationNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[4].isInUse());
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[5].byteOffset() == 300);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[5].generationNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[5].isInUse());
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[6].byteOffset() == 384);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[6].generationNumber() == 0);
	EXPECT_TRUE(fileVersion.xref().section().subsections()[0].entries()[6].isInUse());
	EXPECT_TRUE(fileVersion.trailer().size() == 7);
	EXPECT_FALSE(fileVersion.trailer().hasPrev());
	EXPECT_TRUE(fileVersion.trailer().root().objectNumber() == 1);
