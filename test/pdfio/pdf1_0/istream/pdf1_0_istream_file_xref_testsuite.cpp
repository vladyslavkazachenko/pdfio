...
TEST(FileXrefTestSuite, sectionWith1Subsection)
{
	...
	EXPECT_TRUE(fileXref.section().subsections()[0].objectNumber() == 10);
	EXPECT_TRUE(fileXref.section().subsections()[0].entries().size() == 2);
	EXPECT_TRUE(fileXref.section().subsections()[0].entries()[0].byteOffset() == 3);
	EXPECT_TRUE(fileXref.section().subsections()[0].entries()[0].generationNumber() == 3);
	EXPECT_FALSE(fileXref.section().subsections()[0].entries()[0].isInUse());
	EXPECT_TRUE(fileXref.section().subsections()[0].entries()[1].byteOffset() == 17);
	EXPECT_TRUE(fileXref.section().subsections()[0].entries()[1].generationNumber() == 0);
...
TEST(FileXrefTestSuite, sectionWith2Subsections)
{
	...
	EXPECT_TRUE(fileXref.section().subsections()[0].entries()[1].generationNumber() == 0);
	EXPECT_TRUE(fileXref.section().subsections()[0].entries()[1].isInUse());
	EXPECT_TRUE(fileXref.section().subsections()[1].objectNumber() == 12);
	EXPECT_EQ(1, fileXref.section().subsections()[1].entries().size());
	EXPECT_TRUE(fileXref.section().subsections()[1].entries()[0].byteOffset() == 3456);
	EXPECT_TRUE(fileXref.section().subsections()[1].entries()[0].generationNumber() == 0);
